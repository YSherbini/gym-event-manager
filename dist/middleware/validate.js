...
exports.isValidObjectId = exports.validateNameForUpdate = exports.checkExistingEmailForUpdate = exports.validateEmailForUpdate = exports.checkExistingEmail = exports.validateName = exports.validatePassword = exports.validateEmail = void 0;
...
const validateNameForUpdate = (req, res, next) => {
    const { name } = req.body;
    if (name === '') {
        return res.status(422).json({ error: 'Name must be not empty' });
    }
...
exports.validateNameForUpdate = validateNameForUpdate;
